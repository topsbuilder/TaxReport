...
gulp.task('bundle:app', function() {
    ...
    return builder.buildStatic('app/main.js', paths.prod + 'app.min.js', { minify: true, sourceMaps: true }); //uglify-js only support ECMAScript 5 (ES5)
});
...
/***** customized script start:: *****/
gulp.task('clean:dev', function() {
	var files2del = ['./app/**', '!./app', './css/*.css', './index.html', './dist/dev/**', '!./dist/dev'];
	del.sync(files2del);
});
/***** customized script end:: *****/
